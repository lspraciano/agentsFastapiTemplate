...
from app.infrastructure.logger.http.configure_http_logger import configure_http_logger

http_logger: logging.Logger = configure_http_logger()


def register_http_logger_middleware(
        app: FastAPI
) -> None:
    ...
    async def api_logging(
        ...
        try:
            ...
            log_message: dict = {
                ...
                "client_ip": getattr(request.state, "real_ip", "undefined"),
